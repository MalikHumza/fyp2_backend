...
const Applications = ({jobDetails,setResumeId,setSelectedPage,setSearchParams,setCoverLetterId,setRecentApplications}) => {
  ...
  const sendConfirmationEmail = (email,jobDescription) => {
    fetch('https://server-portal-phi.vercel.app/api/sendconfirmationemail', {
      method: 'post',
      headers: {
              ...
              <Grid item xs={12} md={5} display="flex" justifyContent="center">
                ...
                >
                  ...
                  <Typography
                    ...
                    p={2}
                    component="div"
                    onClick={() => sendConfirmationEmail(item?.userDetails?.email,item?.resume?.jobDescription)}
                  >
                    <Email />
