import { AccountBalance, Adb, Favorite, FavoriteBorder, LocationOn, FileCopy } from "@mui/icons-material"
        ...
        <Box component="div">
            ...
            </Box>
            {
                appliedJobs?.map((item) => {
                    console.log("item",item.appliedCandidate[0].resume.selectedTemplate)
                             return (
                        <Box component="div" sx={{
                                        ...
                                        <Box component="div">
                                            ...
                                            <Box component="div" sx={{ display: "flex", alignItems: "center", width: "20rem", gap: "10px", marginTop: "10px" }}>
                                                ...
                                                {/* <Box component="div" sx={{ display: "flex", alignItems: "center" }}>
                                                    ...
                                                    <Typography variant="h3" sx={{ fontSize: "16px !important", fontWeight: "400 !important", color: textColor }}>
                                                        {item?.appliedCandidate[0].resume.selectedTemplate}
                                                    </Typography>
